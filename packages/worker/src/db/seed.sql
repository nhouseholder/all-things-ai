...
((SELECT id FROM tools WHERE slug='qwen-code'), 'Code Pro', NULL, NULL, '{"features":["Qwen Studio","Web Dev workspace","Deep Research","Search","API Platform"],"requests":"Public monthly cap details are not clearly documented","comparison":{"track":"coding-subscription","hidden_from_catalog":true,"pricing_confidence":"reference","reference_price_label":"$50/mo reference","reference_price_monthly":50,"model_anchor":"Qwen 3.5 Plus","capability_summary":"Broad first-party coding and research surface with desktop, mobile, and API coverage.","best_for":["research-heavy debugging","web builds","multi-device workflows"],"tradeoffs":["Official monthly checkout pricing was not directly extractable from the reviewed public pages","Third-party IDE integrations are less clearly documented than app surfaces"],"ide_support":["Web","iOS","Android","macOS","Windows","API Platform"],"limit_summary":"Public monthly cap and reset details were not clearly documented on the official surfaces reviewed.","limit_reset":"Not clearly documented","overage_path":"Verify current fair-use and upgrade terms before purchase","support_scope":"First-party app surfaces are documented more clearly than IDE plug-ins."}}', '["qwen-3.5-plus"]', 'verify-before-buy', 'Public pricing and cap details should be rechecked on checkout because the official page did not expose them cleanly.'),
