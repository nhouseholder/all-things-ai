...
export const MONITOR_SOURCES = [
  ...
  { key: 'github-copilot-blog', name: 'GitHub Copilot Blog', url: 'https://github.blog/tag/copilot/', type: 'blog' },
  { key: 'github-copilot-plans', name: 'GitHub Copilot Plans', url: 'https://github.com/features/copilot/plans', type: 'pricing' },
  { key: 'claude-code', name: 'Anthropic Claude Code', url: 'https://www.anthropic.com/claude-code', type: 'product' },
  { key: 'openai-codex', name: 'OpenAI Codex', url: 'https://openai.com/codex/', type: 'product' },
  { key: 'gemini-code-assist', name: 'Gemini Code Assist', url: 'https://cloud.google.com/gemini/docs/codeassist/overview', type: 'product' },
  { key: 'moonshot-kimi', name: 'Moonshot / Kimi', url: 'https://www.moonshot.ai/', type: 'blog' },
  { key: 'kimi-pricing', name: 'Kimi Pricing', url: 'https://platform.kimi.com/docs/price/chat', type: 'pricing' },
  { key: 'zhipu-glm', name: 'Zhipu AI / GLM', url: 'https://www.zhipuai.cn/', type: 'blog' },
  { key: 'minimax-news', name: 'MiniMax News', url: 'https://www.minimax.io/news', type: 'blog' },
  { key: 'minimax-pricing', name: 'MiniMax Pricing', url: 'https://platform.minimax.io/docs/pricing/overview', type: 'pricing' },
